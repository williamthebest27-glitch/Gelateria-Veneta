          ...
          >
            <div>
              <div className="flex items-center gap-2.5 text-[12px] uppercase tracking-[0.28em] text-accent">
                ...
                <span
                  data-ready={inView}
                  className="inline-block translate-y-2 opacity-0 transition-[opacity,transform,translate,scale,rotate] duration-700 ease-brand [transition-delay:0.1s] data-[ready=true]:translate-y-0 data-[ready=true]:opacity-100"
                >
                  Carta dei gusti
                </span>
              </div>
